...
MAIN_TABLE_NAME = 'usr_{}'.format(userID)
DB_NAME = 'clientDB'
...
def msg_receiver(mydb,cursor,userID,clientObj):
    ...
    while True:
        ...
        if msg.get('type') == 'MessagRecv':
            ...
            sender_info = ("INSERT INTO usr_9884465584 (time,contacts, status, reply_status, message) VALUES (%(time)s, %(contacts)s, %(status)s,%(reply_status)s, %(message)s)")
